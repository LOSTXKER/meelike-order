...
export default function CaseDetailPage() {
  ...
  // Show only 3 recent activities by default
  const recentActivities = showAllActivities 
    ? caseDetail.activities 
    : caseDetail.activities?.slice(0, 3) || [];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="p-4 sm:p-6">
        <div className="max-w-[1400px] mx-auto grid gap-6 lg:grid-cols-[1fr_280px]">
          {/* Main Content */}
            ...
            <Card>
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-lg font-bold">ประวัติ</CardTitle>
                  {caseDetail.activities && caseDetail.activities.length > 3 && (
                    <Button 
                      variant="ghost" 
                      size="sm"
                    ...
                    >
                      ...
                      <ChevronDown className={cn("h-3 w-3 ml-1 transition-transform", showAllActivities && "rotate-180")} />
                    </Button>
                  )}
                </div>
              </CardHeader>
